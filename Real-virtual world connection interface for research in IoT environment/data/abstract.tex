...
\begin{enumerate}
    ...
    \item 提供了开发工具包，具备丰富的可重用部件和功能，供研究人员快速开发AIoT 原型交互系统。
\end{enumerate}
